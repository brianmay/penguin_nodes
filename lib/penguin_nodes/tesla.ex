defmodule PenguinNodes.Tesla do
  @moduledoc "A server that keeps track of the latest Tesla information"

  use GenServer
  require Logger

  defp robotica, do: Application.get_env(:penguin_nodes, :robotica)
  ...
  def get_next_time(now, interval) do
    PenguinNodes.Times.round_time(now, interval, 1)
  end
  ...
  defp publish_msg(msg, old, new) do
    ...
    if robotica() do
      PenguinNodes.Robotica.publish_message(str)
    end
  end
