...
config :penguin_nodes, PenguinNodesWeb.Endpoint,
  http: [
    :inet6,
    port: port,
  ...
  render_errors: [view: PenguinNodesWeb.ErrorView, accepts: ~w(html json)],
  pubsub_server: PenguinNodes.PubSub,
  live_view: [
